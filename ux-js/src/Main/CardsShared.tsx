...
export function TextBox(props: { label: string, value: string }) {
    ...
    return (
        <Box sx={{ width: '100%', position: 'relative', display: 'inline-flex', flexDirection: 'column', marginTop: '15px' }}>
            <label id={`${id}-label`} htmlFor={id} style={{ color: labelColor, position: 'absolute', left: 0, top: 0, fontFamily: '"Roboto","Helvetica","Arial",sans-serif', fontWeight: 400, lineHeight: '1.4375em', letterSpacing: '0.00938em', transform: 'translate(7px, -12px) scale(0.75)' }}>{props.label}</label>
